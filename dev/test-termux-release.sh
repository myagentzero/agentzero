...
ASSET_URL="https://github.com/myagentzero/zeroclaw/releases/download/${TAG}/${ASSET_NAME}"
...
CHECKSUMS_URL="https://github.com/myagentzero/zeroclaw/releases/download/${TAG}/SHA256SUMS"
