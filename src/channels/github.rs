...
mod tests {
    ...
    fn parse_issue_comment_event_created() {
        ...
        let payload = serde_json::json!({
            ...
            "comment": {
                ...
                "html_url": "https://github.com/myagentzero/zeroclaw/issues/2079#issuecomment-12345",
                "user": { "login": "alice", "type": "User" }
            }
        });
        let msgs = ch.parse_webhook_payload("issue_comment", &payload);
        assert_eq!(msgs.len(), 1);
        assert_eq!(msgs[0].reply_target, "myagentzero/zeroclaw#2079");
    ...
    fn parse_pr_review_comment_event_created() {
        ...
        let payload = serde_json::json!({
            ...
            "comment": {
                ...
                "created_at": "2026-02-27T14:00:00Z",
                "html_url": "https://github.com/myagentzero/zeroclaw/pull/2118#discussion_r9001",
                "user": { "login": "bob", "type": "User" }
            }
        });
        let msgs = ch.parse_webhook_payload("pull_request_review_comment", &payload);
        assert_eq!(msgs.len(), 1);
        assert_eq!(msgs[0].reply_target, "myagentzero/zeroclaw#2118");
    ...
    fn parse_issue_recipient_format() {
        assert_eq!(
            GitHubChannel::parse_issue_recipient("myagentzero/zeroclaw#12"),
            Some(("myagentzero/zeroclaw", 12))
        );
    ...
    fn allowlist_supports_wildcards() {
        let ch = GitHubChannel::new("t".into(), None, vec!["myagentzero/*".into()]);
        assert!(ch.repo_is_allowed("myagentzero/zeroclaw"));
